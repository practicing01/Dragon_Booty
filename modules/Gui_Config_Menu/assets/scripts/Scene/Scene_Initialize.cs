...
%this.GuiControl_Config_Menu->GuiTextEditCtrl_Player_Name.setText($pref::Dragon_Booty::Player_Name);

%this.GuiControl_Config_Menu->GuiTextEditCtrl_IP.setText($pref::Dragon_Booty::Master_IP);

%this.GuiControl_Config_Menu->GuiTextEditCtrl_P2P_IP.setText($pref::Dragon_Booty::P2P_IP);
