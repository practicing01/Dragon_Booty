...
for (%x=0;%x<Scene_Dragon_Booty.getCount();%x++)
{

%Object=Scene_Dragon_Booty.getObject(%x);
...
Scene_Dragon_Booty.createDistanceJoint(%Dove_Head,%Dove_Body,
%Dove_Head.getLocalPoint(%Dove_Body.Position),"0 0",0.1,3,0.0,true);

Scene_Dragon_Booty.createDistanceJoint(%Dove_Leftwing,%Dove_Body,
%Dove_Leftwing.getLocalPoint(%Dove_Body.Position),"0 0",0.1,3,0.0,true);

Scene_Dragon_Booty.createDistanceJoint(%Dove_Leftleg,%Dove_Body,
%Dove_Leftleg.getLocalPoint(%Dove_Body.Position),"0 0",0.1,3,0.0,true);

Scene_Dragon_Booty.createDistanceJoint(%Dove_Rightwing,%Dove_Body,
%Dove_Rightwing.getLocalPoint(%Dove_Body.Position),"0 0",0.1,3,0.0,true);

Scene_Dragon_Booty.createDistanceJoint(%Dove_Rightleg,%Dove_Body,
